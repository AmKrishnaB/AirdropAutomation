...
public class emailUtilities {
    public static void createAccount(){
        ...
        String requestBody = "{\n" +
                "  \"address\": \"usemynjergvethet@fthcapital.com\",\n" +
    ...
    public static void createToken(){
        ...
        String responseBodyString = given().log().all().contentType("application/json").body(requestBody).
    ...
    public static void readOtpAndDelete(){
        String responseBodyString = given().log().all().header("accept", "application/ld+json").header("Authorization", "Bearer "+email.token).
